...
class AccountHostScreen extends StatefulWidget {
  final String nombre;
  final String rol;

  const AccountHostScreen({super.key, required this.rol, required this.nombre});

  @override
  State<AccountHostScreen> createState() => _AccountHostScreenState();
}

class _AccountHostScreenState extends State<AccountHostScreen> {
