...
class _ProfileGuestScreenState extends State<ProfileGuestScreen> {
  ...
  // ✅ Mantenemos el método del mensaje sin cambios, pero le asignamos el estado correcto
  ...
  Future<void> _updateProfile() async {
    ...
    // ✅ La función del servicio ahora devuelve un String?
    ...
    if (mounted) {
      setState(() {
        ...
        if (message != null) {
          _mensaje = message;
          // Asumimos que si hay un mensaje, es un éxito.
          // Si el backend envía mensajes de error, necesitas una lógica para distinguirlos.
          // Por ejemplo: if(message.startsWith('Error:')) _isError = true;
          _isError = false; 
        } else {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // ✅ Usamos un Stack para que el mensaje flote sobre el contenido
      body: Stack(
        children: [
          ...
          // ✅ Llamamos al widget del mensaje para que flote sobre el contenido
          _buildMensaje(),
        ],
      ),
    );
