...
void initState() {
  super.initState();
  _rolActual = widget.rol; // Inicializa rol
  loadUserData();
}
Future<void> loadUserData() async {
  ...
  if (data != null) {
    setState(() {
      ...
      // Si rol es lista y tiene elementos, toma el primero
      if (userData?['rol'] is List && (userData?['rol'] as List).isNotEmpty) {
        _rolActual = (userData?['rol'] as List).first.toString();
      } else {
        _rolActual = '';
      }
                ...
                children: [
                  ...
                  ListTile(
                      ...
                      onTap: () async {
                        ...
                        if (result == true) {
                          // Si en la pantalla de editar devuelves true después de guardar cambios
                          await loadUserData();
                        }
                      },
),
