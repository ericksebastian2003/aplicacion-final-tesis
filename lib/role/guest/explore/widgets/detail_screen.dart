        ...
        : accommodation == null
            ...
            : Stack(
                children: [
                  ...
                  if (fotos.isNotEmpty)
                    SizedBox(
                      height: 280, // un poco más alto para que encaje bien
                      child: Stack(
                        children: [
                          PageView.builder(
                  ...
                  DraggableScrollableSheet(
                    initialChildSize: 0.65,  // Un poco más alto para empezar casi pegado al carrusel
                    minChildSize: 0.65,
                    maxChildSize: 0.95,
                    builder: (_, controller) => Container(
                      ...
                      child: ListView(
                        ...
                        padding: EdgeInsets.zero, // Quitar padding extra del ListView
                        shrinkWrap: true,         // Que solo ocupe lo que necesita
                        children: [
