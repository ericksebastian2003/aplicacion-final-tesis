...
import 'package:desole_app/features/host/account/account_host_screen.dart';
import 'package:desole_app/features/host/advertisements/advertisements_screen.dart';
import 'package:desole_app/features/host/reserves/reserves_screen.dart';
...
class _HostDashboardState extends State<HostDashboard> {
  ...
  Widget build(BuildContext context) {
    final List<Widget> _pages = [
      ...
      // ReservesScreen(),
      const Center(child: Text('Está en implementación. Vuelva pronto')),
